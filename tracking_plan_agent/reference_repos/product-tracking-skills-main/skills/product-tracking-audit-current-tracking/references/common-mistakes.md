...
**Result:**
- Massive data volume and cost
- Signal buried in noise
- Nobody trusts the data because there's too much
- Performance impact on client

**Fix:** Track what answers real questions. Add more when needed.
...
**Fix:** Pick a convention (we recommend `object.action` snake_case) and enforce it.
...
**Fix:** Track outcomes: `report.created`, not `create_report_button.clicked`.
